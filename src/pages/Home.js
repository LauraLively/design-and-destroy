...
function Homepage () {
    ...
    return (
        ...
        <div id="btn-container" class="d-flex justify-content-evenly grid gap-3 mt-4 mb-4">
            ...
            <Button type="button" class="btn btn-primary p-2 g-col-3" href="#/Classes">Classes</Button>
            <Button type="button" class="btn btn-primary p-2 g-col-3" href="#/Races">Races</Button>
